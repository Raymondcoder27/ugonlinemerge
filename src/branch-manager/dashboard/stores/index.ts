...
import {type GatewayResponseInterface} from "@/branch-manager/gateway/types";
import api from "@/config/api";
import type {ProviderRegistrationStatistic, Statistic} from "@/branch-manager/analytics/types/chart";
