...
import CreateServiceProvider from "@/tilloperatordomain/entities/views/CreateServiceProvider.vue";
import moment from "moment";
import coa from "@/assets/images/coa_gs.png"
import EditServiceProvider from "@/tilloperatordomain/entities/views/EditServiceProvider.vue";
import type {ServiceProvider} from "@/tilloperatordomain/entities/types";
