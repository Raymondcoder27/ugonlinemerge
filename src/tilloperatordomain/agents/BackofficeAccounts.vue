...
import CreateAccount from "@/tilloperatordomain/accounts/components/CreateAccount.vue";
import AddAgent from "@/tilloperatordomain/agents/components/AddAgent.vue"
