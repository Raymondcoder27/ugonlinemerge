...
import {type GatewayResponseInterface} from "@/tilloperatordomain/gateway/types";
import api from "@/config/api";
import type {ProviderRegistrationStatistic, Statistic} from "@/tilloperatordomain/analytics/types/chart";
