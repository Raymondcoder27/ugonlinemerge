...
import GatewayStatistics from "@/tilloperatordomain/analytics/views/GatewayStatistics.vue";
import {type Ref, ref} from "vue";
import ProviderStatistics from "@/tilloperatordomain/analytics/views/ProviderStatistics.vue";
import ServicesStatistics from "@/tilloperatordomain/analytics/views/ServicesStatistics.vue";
import RevenueStatistics from "@/tilloperatordomain/analytics/views/RevenueStatistics.vue";
import UserStatistics from "@/tilloperatordomain/analytics/views/UserStatistics.vue";
