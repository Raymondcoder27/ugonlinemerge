...
import type {ServiceResponseInterface} from "@/tilloperatordomain/services/types";
import type {AccessibilityTier, Category} from "@/tilloperatordomain/settings/types";
