...
const mergedRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    redirect: "/branchmanagerdomain/dashboard",
    children: [
      { name: "branch-manager-app-dashboard", path: "/branchmanagerdomain/dashboard", component: BranchManagerDashboardTab },
      { name: "branch-manager-app-services", path: "/branchmanagerdomain/app-services", component: BranchManagerAppServices },
      { name: "branch-manager-app-entities", path: "/branchmanagerdomain/entities", component:BranchManagerAppEntities },
      { name: "branch-manager-app-agents", path: "/branchmanagerdomain/agents", component:BranchManagerAppAgents },
      { name: "branch-manager-app-branches", path: "/branchmanagerdomain/branches", component:BranchManagerTills },
      { name: "branch-manager-app-configurations", path: "/branchmanagerdomain/configurations", component:BranchManagerSettings },
      // { name: "branchmanager-app-ledger", path: "/branchmanagerdomain/ledger", component:BranchManagerLedger },
      { name: "branch-manager-app-services-details", path: "/branchmanagerdomain/services-details", component:BranchManagerServicesDetails },
      { name: "branch-manager-app-finances", path: "/branchmanagerdomain/finances", component:BranchManagerAppFinances },
      { name: "branch-manager-app-gateway", path: "/branchmanagerdomain/gateway", component:BranchManagerAppGateway },
      { name: "branch-manager-app-tills", path: "/branchmanagerdomain/tills", component:BranchManagerTills },
//       branch-manager-app-reports
// branch-manager-app-accounts
       { name: "branch-manager-app-reports", path: "/branchmanagerdomain/data-analytics", component: BranchManagerDataAnalytics },
       { name: "branch-manager-app-accounts", path: "/branchmanagerdomain/accounts", component: BranchManagerAccounts },
