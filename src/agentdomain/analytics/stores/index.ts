...
import {type GatewayResponseInterface} from "@/agentdomain/gateway/types";
import api from "@/config/api";
import type {ProviderRegistrationStatistic, Statistic} from "@/agentdomain/analytics/types/chart";
