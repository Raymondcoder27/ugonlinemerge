...
import GatewayStatistics from "@/agentdomain/analytics/views/GatewayStatistics.vue";
import {type Ref, ref} from "vue";
import ProviderStatistics from "@/agentdomain/analytics/views/ProviderStatistics.vue";
import ServicesStatistics from "@/agentdomain/analytics/views/ServicesStatistics.vue";
import RevenueStatistics from "@/agentdomain/analytics/views/RevenueStatistics.vue";
import UserStatistics from "@/agentdomain/analytics/views/UserStatistics.vue";
