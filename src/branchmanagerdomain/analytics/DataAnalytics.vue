...
import GatewayStatistics from "@/branchmanagerdomain/analytics/views/GatewayStatistics.vue";
import {type Ref, ref} from "vue";
import ProviderStatistics from "@/branchmanagerdomain/analytics/views/ProviderStatistics.vue";
import ServicesStatistics from "@/branchmanagerdomain/analytics/views/ServicesStatistics.vue";
import RevenueStatistics from "@/branchmanagerdomain/analytics/views/RevenueStatistics.vue";
import UserStatistics from "@/branchmanagerdomain/analytics/views/UserStatistics.vue";
